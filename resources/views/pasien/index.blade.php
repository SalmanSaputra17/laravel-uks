...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <a href="{{ route('pasien.export') }}" class="btn btn-success btn-sm" style="margin-bottom: 15px;">Export Excel</a>
      <div class="card">
        <div class="card-header">
          Data Pasien
        </div>
        <div class="card-body">
          <form class="form-inline" action="{{ route('pasien.search') }}">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="dataPasien">
              ...
              <tbody class="text-center">
                ...
                @foreach( $pasiens as $pasien )
                    <tr>
                      ...
                      <td>
                        <form action="{{ route('pasien.delete', $pasien) }}" method="post">
                          @csrf
                          {{ method_field('DELETE') }}
